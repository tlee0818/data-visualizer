...
function newCloudPlugin () : DisplayPlugin {
    ...
    let makeWordcloudOptions = function (image: FrameworkImage)  {
        ...
        return {list : listOption.slice(1), color : createColorOption}
    }
       ...
       return {
        ...
        getChart: function (image: FrameworkImage) : string {
           ...
           })(this) // jshint ignore:line></script>      
            <div id="chart"></div>
            <script>
            WordCloud(document.getElementById('chart'), JSON.parse('${JSON.stringify(options)}') );
            </script>
            `
        },
